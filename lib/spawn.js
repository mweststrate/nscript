...
var expandArgument = exports.expandArgument = function(arg, applyGlobbing) {
	...
	if (arg === null || arg === undefined || typeof arg === "function")
		throw new Error("Spawn argument should not be null, undefined or a function");
	if (util.isArray(arg))
		return arg;
...
exports.spawn = function(commandAndArgs, opts) {
	var commandAndArgs = [].concat(commandAndArgs); //safe copy
	var stdio;
	...
	var child = child_process.spawn(cmd, commandAndArgs, {
		...
		stdio : stdio = [
			...
			'pipe', //TODO: spawned process don't have colors, can we mark the pipe as TTY?
			'pipe'
		]
	});
